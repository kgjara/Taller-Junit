...
//        _movieRentals.forEach((mov) -> {
        Iterator<MovieRental> movIterator = getMovieRentals().iterator();
        Iterator<VideoGameRental> gameIterator = getVideoGameRental().iterator();
